...
# - clearn up
rm(df_wthr_join_list, df_pca_list, train_index); gc()
...
# - fit: train
fit_logit <- glm(WnvPresentF ~ Latitude*Longitude + Species + PC1_temp*PrecipTotalLog + I(PC1_temp^2) + I(PrecipTotalLog^2) + Month + WkDay + PC1_pres_lvl + I(PC1_pres_lvl^2) + SunriseNum + I(SunriseNum^2), family="binomial", weights=Weight, data=df_train_wthr_fit)
# - print model
summary(fit_logit)
...
# - fit: train + vaidation
fit_logit_all <- glm(WnvPresentF ~ Latitude*Longitude + Species + PC1_temp*PrecipTotalLog + I(PC1_temp^2) + I(PrecipTotalLog^2) + Month + WkDay + PC1_pres_lvl + I(PC1_pres_lvl^2) + SunriseNum + I(SunriseNum^2), family="binomial", weights=Weight, data=df_train_wthr)
